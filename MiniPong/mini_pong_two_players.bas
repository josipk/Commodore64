...
50 printtab(14)"{white}mini pong"
51 printtab(12)"{orange}two players"
...
400 foru=3to.step.:j1=not(peek(56321)):j2=not(peek(56320))

410 if (j1 and 1) then if b1>70 then b1=b1-5:poke y0,b1
420 if (j2 and 2) then if b2<100 then b2=b2+5:poke y1,b2
430 if (j1 and 2) then if b1<100 then b1=b1+5:poke y0,b1
440 if (j2 and 1) then if b2>70 then b2=b2-5:poke y1,b2
...
620 if xd>0 then x=x+4: ifx<34then xd=-xd:x=x-4
