Scrolling Downwards in Commodore Basic
-------------------------------------


Scrolling Downwards - v1
```
0 ?cH(147)cH(5):sys59749
1 ?cH(19)cH(13)cH(13)sPrN(.)*38)"*";
2 ?cH(19):sys59777:gO1
```

Scrolling Downwards - v2
```
0 ?cH(147)cH(5):sys59749
1 pO214,4:pO211,rN(.)*39:sys58732:?"*";
2 pO214,0:pO211,0:sys58732:sys59777:gO1
```


Let it Snow in Basic - Christmas Card
```
